...
try:
    ...
    try:
        from model.correlation import FunctionCorrelation
    except ImportError:
        import sys
        import os
            ...
            def forward(self, tensorFirst, tensorSecond, objectPrevious):
                ...
                if objectPrevious is None:
                    ...
                    tensorVolume = torch.nn.functional.leaky_relu(
                        input=FunctionCorrelation(tensorFirst=tensorFirst, tensorSecond=tensorSecond),
                    ...
                    tensorVolume = torch.nn.functional.leaky_relu(
                        input=FunctionCorrelation(tensorFirst=tensorFirst,
